            ...
            concat: {
                files: {
                    '<%= pkg.output %>js/melisa-sencha-classic.min.js': [
                        ...
                        '<%= pkg.sencha %>override/form/field/Checkbox.js',
                        '<%= pkg.sencha %>override/form/field/DateField.js',
                        '<%= pkg.sencha %>override/form/field/Number.js',
                        '<%= pkg.sencha %>override/grid/column/Widget.js',
                        '<%= pkg.sencha %>override/grid/column/Boolean.js',
                        '<%= pkg.sencha %>override/window/Window.js',
                        ...
                        '<%= pkg.sencha %>core/module/Assets.js',
                        '<%= pkg.sencha %>core/Module.js',
                        '<%= pkg.sencha %>view/desktop/wrapper/window/Add.js',
                        '<%= pkg.sencha %>view/desktop/wrapper/window/View.js',
                    ...
                    '<%= pkg.output %>js/melisa-sencha-modern.min.js': [
                        ...
                        '<%= pkg.sencha %>override/field/Field.js',
                        '<%= pkg.sencha %>override/Button.js',
                        '<%= pkg.sencha %>override/form/Panel.js',
                        '<%= pkg.sencha %>override/form/Text.js',
                        '<%= pkg.sencha %>util/Format.js',
                        '<%= pkg.sencha %>override/ux/Iframe.js',
